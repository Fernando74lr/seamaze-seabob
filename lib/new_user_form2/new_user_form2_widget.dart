...
import 'new_user_form2_model.dart';
export 'new_user_form2_model.dart';

class NewUserForm2Widget extends StatefulWidget {
  const NewUserForm2Widget({Key? key}) : super(key: key);

  @override
  _NewUserForm2WidgetState createState() => _NewUserForm2WidgetState();
}

class _NewUserForm2WidgetState extends State<NewUserForm2Widget> {
  late NewUserForm2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewUserForm2Model());

    _model.nicknameGuestController ??= TextEditingController();
  }
