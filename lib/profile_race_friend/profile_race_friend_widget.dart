...
import 'profile_race_friend_model.dart';
export 'profile_race_friend_model.dart';

class ProfileRaceFriendWidget extends StatefulWidget {
  const ProfileRaceFriendWidget({
    Key? key,
  ...
  @override
  _ProfileRaceFriendWidgetState createState() =>
      _ProfileRaceFriendWidgetState();
}

class _ProfileRaceFriendWidgetState extends State<ProfileRaceFriendWidget> {
  late ProfileRaceFriendModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileRaceFriendModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final profileRaceFriendUsersRecord = snapshot.data!;
                ...
                children: [
                  wrapWithModel(
                    ...
                    child: CustomAppBarWidget(
                      title: profileRaceFriendUsersRecord.username,
                      title2: 'Races',
                    ),
                  ),
                  Padding(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      profileRaceFriendUsersRecord.displayName,
                                    ...
                                    Text(
                                      profileRaceFriendUsersRecord.bio
                                          .maybeHandleOverflow(
                                        maxChars: 200,
                                        replacement: '…',
                                      ),
                                      ...
                                      children: [
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              'Since ${dateTimeFormat('Md', profileRaceFriendUsersRecord.createdTime)}',
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .bodyMedium
                                                  .override(
                                      ...
                                      Expanded(
                                        child: Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              if (!profileRaceFriendUsersRecord
                                                  .followers
                                                  .contains(
                            ...
                            StreamBuilder<List<RacesRecord>>(
                              stream: queryRacesRecord(
                                queryBuilder: (racesRecord) => racesRecord
                                    .where('host', isEqualTo: widget.userRef)
                                                    ...
                                                    Expanded(
                                                      child: wrapWithModel(
                                                        ...
                                                        child: CarouselWidget(
                                                          key: Key(
                                                            'Keyxzg_${activitiesDBIndex.toString()}',
                                                          ),
                                                          imagesPath:
                                                              activitiesDBRacesRecord
                                                                  .imagesPath,
                                                                    ...
                                                                    onTap:
                                                                      ...
                                                                      context
                                                                        ...
                                                                        queryParameters:
                                                                          ...
                                                                          'raceRef':
                                                                              serializeParam(
                                                                            activitiesDBRacesRecord.reference,
