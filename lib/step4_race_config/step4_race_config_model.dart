...
class Step4RaceConfigModel extends FlutterFlowModel {
  ...
  // Stores action output result for [Backend Call - API (Begin race)] action in Button widget.
  ApiCallResponse? responseBeginRace;
